...
resolve to real, already-produced pipeline outputs, and declare the same
required_paths that full/thresholded do -- no other change needed.
    ...
    registry.TableSpec(
        ...
        variants=[
            ...
            registry.VariantSpec(
                ...
                required_paths=_requires(_elements_bed_path),
